...
If you need support contact us at http://www.salesautopilot.com/contact-us
...
Then click to Save changes button at the bottom. The you can see your eCommerce lists in the first dropdown list. 
Select the one you want WooCommerce integrate with. 
Click again to the Save changes button, then select the Order form you want the WooCommerce connect with. Then again click to the Save changes button.
